 ...
 */
export const resendUserInvitationV1AuthResendInvitePost = <ThrowOnError extends boolean = false>(options: Options<ResendUserInvitationV1AuthResendInvitePostData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).post<ResendUserInvitationV1AuthResendInvitePostResponses, ResendUserInvitationV1AuthResendInvitePostErrors, ThrowOnError>({
        security: [
            {
                scheme: 'bearer',
                type: 'http'
 ...
 */
export const getDisbursementVoucherV1ReportsV1ReportsDisbursementVoucherSchoolIdYearMonthDateGet = <ThrowOnError extends boolean = false>(options: Options<GetDisbursementVoucherV1ReportsV1ReportsDisbursementVoucherSchoolIdYearMonthDateGetData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).get<GetDisbursementVoucherV1ReportsV1ReportsDisbursementVoucherSchoolIdYearMonthDateGetResponses, GetDisbursementVoucherV1ReportsV1ReportsDisbursementVoucherSchoolIdYearMonthDateGetErrors, ThrowOnError>({
        security: [
            {
                scheme: 'bearer',
                type: 'http'
...
/**
 * Create Or Update Disbursement Voucher
 * Create or update a disbursement voucher.
 */
export const createOrUpdateDisbursementVoucherV1ReportsV1ReportsDisbursementVoucherSchoolIdYearMonthDatePost = <ThrowOnError extends boolean = false>(options: Options<CreateOrUpdateDisbursementVoucherV1ReportsV1ReportsDisbursementVoucherSchoolIdYearMonthDatePostData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).post<CreateOrUpdateDisbursementVoucherV1ReportsV1ReportsDisbursementVoucherSchoolIdYearMonthDatePostResponses, CreateOrUpdateDisbursementVoucherV1ReportsV1ReportsDisbursementVoucherSchoolIdYearMonthDatePostErrors, ThrowOnError>({
        security: [
            {
                scheme: 'bearer',
                type: 'http'
...
/**
 * Get Disbursement Vouchers For Month
 * Get all disbursement vouchers for a specific month, optionally filtered by linked liquidation category.
 */
export const getDisbursementVouchersForMonthV1ReportsV1ReportsDisbursementVoucherSchoolIdYearMonthGet = <ThrowOnError extends boolean = false>(options: Options<GetDisbursementVouchersForMonthV1ReportsV1ReportsDisbursementVoucherSchoolIdYearMonthGetData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).get<GetDisbursementVouchersForMonthV1ReportsV1ReportsDisbursementVoucherSchoolIdYearMonthGetResponses, GetDisbursementVouchersForMonthV1ReportsV1ReportsDisbursementVoucherSchoolIdYearMonthGetErrors, ThrowOnError>({
        security: [
            {
                scheme: 'bearer',
                type: 'http'
